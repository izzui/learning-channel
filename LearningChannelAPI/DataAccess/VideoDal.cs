	...
	public class VideoDal
	{
		...
		public static IEnumerable<Video> Videos
		{
			get
			{
				return new Video[]
				{
					new Video {Id = 1, LessonId = 1, Order = 1, NextId = 2, Progress = EnumProgress.completed, Title = "Video 1 Title", Thumb = "https://local-learningchannel.izzui.com/oceans-clip.png", Type = VideoType.Html5, Sources = VideoSourceDal.Sources.Where(vs => vs.VideoId == 1).ToList()},
