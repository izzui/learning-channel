			...
			get
			{
				return new Course[]
				{
					new Course
					{
						...
						Lead = "Personal Finance: Another Perspective on Wealth",
						Views = 2478,
					...
					new Course
					{
						...
						Lead = " Creating Your Personal Financial Plan and Setting Personal Goals.",
						Views = 1500,
					...
					new Course
					{
						...
						Lead = " Personal Finance: Understanding Credit.",
						Views = 4000,
						Lessons = LessonDal.Lessons.Where(x=>x.CourseId == 2).OrderBy(l => l.Order).ToArray(),
					...
					new Course
					{
						...
						Lead = "Cash and Liquid Asset Management",
						Views = 7534,
					...
					new Course
					{
						...
						Lead = "This is a beginning course on the importance of understanding consumer and mortgage loans.",
						Views = 2645,
					...
					new Course
					{
						...
						Title = "Debt and Debt Reduction",
						Lead = "This is a beginning course on the importance of understanding and avoiding debt.",
						Views = 18547,
						Lessons = LessonDal.Lessons.Where(x=>x.CourseId == 1).OrderBy(l => l.Order).ToArray(),
						Groups = GroupsDal.Groups.Where(x=>x.CourseId == 1).ToArray(),
					...
					new Course
					{
						...
						Title = "Insurance 1: Basics",
						Lead = "This is an intermediate course on the basics of insurance.",
						Views = 17289,
						Lessons = LessonDal.Lessons.Where(x=>x.CourseId == 2).OrderBy(l => l.Order).ToArray(),
						Groups = GroupsDal.Groups.Where(x=>x.CourseId == 3).ToArray(),
						PublishDate = new DateTime(2012, 1, 1),
					...
					new Course
					{
						...
						Title = "Insurance 2: Life Insurance",
						Lead = "This is an intermediate course on the basics of life insurance.",
						Views = 15453,
						Lessons = LessonDal.Lessons.Where(x=>x.CourseId == 2).OrderBy(l => l.Order).ToArray(),
						Groups = GroupsDal.Groups.Where(x=>x.CourseId == 2).ToArray(),
						PublishDate = new DateTime(2012, 7, 27),
